...
var Choice = {
	...
	view: function (vnode) {
		...
		return m(".choice", { class: Choice.classes(n), onclick: Choice.click(n) }, m("span.l"), m("span.v", Data.current_question()["option_" + n]));
	}
};
...
Question = {
	view: function (vnode) {
		...
		return m(".question_wrapper", m(".question", Data.current_question().question), m(Choice, { index: "a" }), m(Choice, { index: "b" }), m(Choice, { index: "c" }), m(Choice, { index: "d" }));
	}
};
